...
const meta = {
  title: 'Rooms/Information/RoomAmenitiesModalButton',
  component: RoomAmenitiesModalButton,
  parameters: {
    layout: 'padded',
  },
  decorators: [
...
} satisfies Meta<typeof RoomAmenitiesModalButton>;

export default meta;

type Story = StoryObj<typeof RoomAmenitiesModalButton>;
